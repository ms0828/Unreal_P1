...
void UP1AssetData::PreSave(FObjectPreSaveContext ObjectSaveContext)
{
...
FSoftObjectPath UP1AssetData::GetAssetPathByName(const FName& AssetName)
{
...
const FAssetSet& UP1AssetData::GetAssetSetByLabel(const FName& Label)
{
